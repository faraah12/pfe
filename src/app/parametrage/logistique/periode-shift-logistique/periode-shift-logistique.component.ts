...
@Component({
  selector: 'app-periode-shift-logistique',
  templateUrl: './periode-shift-logistique.component.html',
  styleUrl: './periode-shift-logistique.component.css'
})
export class PeriodeShiftLogistiqueComponent {
