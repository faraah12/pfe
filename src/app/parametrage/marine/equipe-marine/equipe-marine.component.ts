...
@Component({
  selector: 'app-equipe-marine',
  templateUrl: './equipe-marine.component.html',
  styleUrl: './equipe-marine.component.css'
})
export class EquipeMarineComponent implements OnInit{
  ...
  constructor(private formBuilder: FormBuilder, private equipeService: EquipeMarineService) {}
